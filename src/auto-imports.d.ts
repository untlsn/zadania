...
declare global {
  ...
  const createInfiniteQuery: typeof import('@tanstack/solid-query')['createInfiniteQuery']
  ...
  const createQuery: typeof import('@tanstack/solid-query')['createQuery']
  ...
  const useQueryClient: typeof import('@tanstack/solid-query')['useQueryClient']
